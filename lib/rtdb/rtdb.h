...
tU32 rtdb_write_tES   ( tESEnumT  VarName, tS32 NewVal );
tU32 rtdb_write_tBS   ( tBSEnumT  VarName, tS8 NewVal );
...
tU32 rtdb_overwrite_tES   ( tESEnumT  VarName, tS32 NewVal );
tU32 rtdb_overwrite_tBS   ( tBSEnumT  VarName, tS8 NewVal );
