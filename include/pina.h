...
{
    // OUTPUTS
    PINA_OUT_NUM_0 = GPIO_NUM_4,
    PINA_OUT_NUM_1 = GPIO_NUM_5,
    PINA_OUT_NUM_2 = GPIO_NUM_6,
    PINA_OUT_NUM_3 = GPIO_NUM_7,
    PINA_OUT_NUM_4 = GPIO_NUM_8,
    PINA_OUT_NUM_5 = GPIO_NUM_9,
    PINA_OUT_NUM_6 = GPIO_NUM_10,
    PINA_OUT_NUM_7 = GPIO_NUM_11,
    PINA_OUT_NUM_8 = GPIO_NUM_12,
    PINA_OUT_NUM_9 = GPIO_NUM_15,
